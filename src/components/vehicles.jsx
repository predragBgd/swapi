...
return(
    <div id="planets" className="row justify-content-center">
            <div id="planets-card"class="card">
                <div class="card-body">
                    <h5 class="card-title">Star Wars Vehicles</h5>
            ...
            {vehicles.map(vehicle => {
                return(
                    <div className="card" key={vehicle.name} style={{width: "16rem"}}>
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target={"#vehicleModal" + vehicle.id}>{vehicle.name}
                        </button>
                        <div class="modal fade" id={"vehicleModal" + vehicle.id} tabindex="-1"                          aria-labelledby="exampleModalLabel" aria-hidden="true">
